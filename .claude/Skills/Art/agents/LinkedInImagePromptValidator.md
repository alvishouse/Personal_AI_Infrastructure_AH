# LinkedIn Prompt Validator Agent
...
- [ ] The emotional state is specific, not generic (not just "stressed" — specify how: "knuckles white, jaw clenched, sweat on brow")
...
- [ ] The viewer would need to read the post to fully understand the context
- [ ] The image does NOT give away the punchline, solution, or framework
- [ ] Uses at least one unexpected or non-obvious visual element that creates intrigue

**Fail conditions:**
- Image literally illustrates the post's conclusion or advice
- The concept could be fully understood without reading anything
...
| Check | Pass Condition | Current Prompt Status |
|-------|---------------|----------------------|
