---
notion_id: "32c0760e-b0cd-8107-a1c9-d8e8a7fbed13"
notion_url: "https://www.notion.so/The-Refinery-Principle-32c0760eb0cd8107a1c9d8e8a7fbed13"
last_synced: "2026-03-23T01:13:28.750Z"
sync_status: "synced"
---
...
![John D. Rockefeller — The Refinery Principle](./10-images/featured-v4.png)
...
Ninety-five percent of AI pilots fail to deliver measurable P&L impact. Eighty-nine percent of executives report no productivity gain from AI. Fifty-six percent of CEOs say they have gotten nothing out of their AI investments.

Same models. Same data access. Same technology generation. Opposite results.

In the oil industry, there is a term for this: the **crack spread**. It is the difference between the price of crude oil and the value of the refined products that come out of the refinery. In June 2022, US refinery crack spreads peaked at $61.95 per barrel. The crude was worth one thing. The refined product was worth dramatically more. The refinery captured all the value.
...
**The widening gap you cannot explain.** BCG's September 2025 research confirmed that the gap between AI leaders and laggards is not narrowing. It is accelerating. Leaders generate 76% higher impact match between where AI is deployed and where it delivers results. The leaders are not using better models. They are using the same models through better infrastructure. The refinery is the variable.
...
![The 4-Layer Refinery Model — Where the Money Lives](./10-images/inline-01-refinery-model.png)
...
1. **What percentage of your AI output reaches a human decision-maker in a useful form?** If you do not know this number, start counting. Most organizations find that fewer than 20% of AI outputs reach a decision context.

2. **How many of those outputs are reviewed, acted on, and tracked back to business outcomes?** The conversion rate from "AI generated something" to "a business decision was made and its outcome was measured" is your refinery efficiency.

3. **Who owns the Layer 2 design in your organization?** Not the AI tools. Not the data pipeline. The conversion infrastructure. If no one owns it, no one is building it. The refinery does not exist.
...
1. Does this output reach a decision-maker?
2. Does it change a decision?
3. Does anyone track the outcome?
...
**"We do not know which decisions to start with."** Start with the decision that costs the most when it is wrong. Not the decision that is easiest to automate. The decision that carries the highest consequence. That is where refinery capacity pays back fastest.

**"We cannot get cross-functional alignment."** The crack spread audit from Week 1 produces a number. That number is the business case. It is difficult to argue against a measured gap. Let the data create the alignment.

**"Our IT team says this is their domain."** The refinery is an operational infrastructure, not a technology infrastructure. IT owns the pipeline (Layer 1). Operations owns the refinery (Layer 2). The plant manager does not report to the pipeline company. Clarify ownership early, or ownership will clarify itself — usually through failure.

![Building the AI Workflow Infrastructure](./10-images/inline-02-construction.png)
...
Stop fighting for crude. Build the refinery.
...
### Extraction Potential Notes

- **LinkedIn authority post:** "Rockefeller didn't drill for oil. He built refineries." — binary reframe hook from Expert Story
- **LinkedIn framework post:** The 4-Layer Refinery Model as a diagnostic carousel
- **LinkedIn data post:** The crack spread concept + 95%/89%/56% stat trio
- **Newsletter "Metric That Matters":** Organizational crack spread — percentage of AI outputs reaching business decisions
- **Newsletter "Myth vs. Reality":** The Driller's Fallacy
- **Lead magnet:** Crack Spread Audit worksheet (Week 1 protocol)
- **Speaking closer:** "Stop buying crude. Build the refinery."
