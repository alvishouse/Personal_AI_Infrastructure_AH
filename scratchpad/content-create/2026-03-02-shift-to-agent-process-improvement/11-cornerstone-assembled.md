...
![Layered architecture diagram showing the Process Layer with Flow Bridges as the connective tissue between AI agents and organizational infrastructure](./images/featured.png)
...
![Diagram of the four Flow Bridge types with the three required properties labeled beneath each bridge connection](./images/inline-01.png)
